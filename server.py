...
# Demo mode settings
DEMO_MAX_QUESTIONS = 10       # Max questions per demo session
DEMO_MAX_PER_TAB   = 3        # Max questions answered per tab in demo
...
async def answer(
    ...
    # Update usage counter in DB
    remaining = None
    if AUTH_ENABLED and db and org and org.tier not in ("test", "demo"):
        try:
